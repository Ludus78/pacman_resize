...
PACMAN_BOOST_MULTIPLIER = 1.75  # Multiplicateur de vitesse lors du boost
GHOST_SPEED_INCREASE = 1.05  # Augmentation de vitesse des fantômes par niveau
...
MIN_FRIGHTENED_DURATION = 5.0  # Durée minimale du mode frightened
