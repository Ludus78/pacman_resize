...
FOV_SHRINK_RATE = 1.5  # Vitesse de rétrécissement du FOV (secondes par tuile)
FOV_BOOST = 5  # Tuiles ajoutées au FOV lors d'un power pellet
GHOST_RESPAWN_TIME = 3.0  # Temps de respawn des fantômes (secondes)
...
# Points
PELLET_VALUE = 1  # Points pour une pastille normale
POWER_PELLET_VALUE = 10  # Points pour une super pastille
GHOST_POINTS = [10, 20, 40, 80]  # Points selon le combo de fantômes mangés
